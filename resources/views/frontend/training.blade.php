...
@section('content')
    ...
    <section id="contact" class="hero contact section">
        ...
        {{-- ======================================================= --}}
        {{-- BAGIAN YANG DIUBAH UNTUK MEMBUAT FORM DI TENGAH --}}
        {{-- ======================================================= --}}
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            {{-- Menambahkan class 'justify-content-center' untuk membuat kolom di dalamnya menjadi di tengah --}}
            <div class="row justify-content-center">
                {{-- Mengubah lebar kolom menjadi lebih kecil (misal: col-lg-8) agar tidak terlalu lebar di layar besar --}}
                <div class="col-lg-6">
                    <div class="form-wrapper" data-aos="fade-up" data-aos-delay="400">
                        <form id="training-form" action="{{ route('training.store') }}" method="post" role="form" class="php-email-form" enctype="multipart/form-data">
                            ...
                            {{-- Menghapus <div class="row"> di sini agar semua elemen form tersusun ke bawah --}}

                            {{-- Employee ID --}}
                            {{-- Mengubah class menjadi 'col-12' agar selalu full-width --}}
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="employee_id" name="employee_id" class="form-select" required>
                                        ...
                                        @foreach($employee as $emp)
                                            <option value="{{ $emp->uuid }}">{{ $emp->name }} - {{ $emp->nip }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            {{-- Sub Diklat ID --}}
                            <div id="sub_diklat_container" class="col-12 form-group mb-3">
                                <div class="input-group">
                            ...
                            <div class="col-12 form-group mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="start_date" name="start_date" class="form-control" placeholder="Tanggal Mulai" onfocus="this.type='date'" onblur="if(!this.value)this.type='text'" required>
                                </div>
                            ...
                            <div class="col-12 form-group mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="end_date" name="end_date" class="form-control" placeholder="Tanggal Selesai" onfocus="this.type='date'" onblur="if(!this.value)this.type='text'" required>
                                </div>
...
@push('scripts')
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            // Logika Submit Form Menggunakan AJAX (tidak berubah)
